...
(async function main() {
...

	{
		...
		await ln.softLink(
			path.join(root, "jsonrpc"),
			path.join(testbedClientFolder, "node_modules", "vscode-jsonrpc"),
		);
		await ln.softLink(
	...
	}
	{
		...
		await ln.softLink(
			path.join(root, "jsonrpc"),
			path.join(testbedServerFolder, "node_modules", "vscode-jsonrpc"),
		);
		await ln.softLink(
			path.join(root, "types"),
			path.join(
