...
export class PortMessageReader
...
export class PortMessageWriter
	extends AbstractMessageWriter
	implements MessageWriter
{
...
export class StreamMessageReader extends ReadableStreamMessageReader {
	public constructor(
		...
		encoding?: RAL.MessageBufferEncoding | MessageReaderOptions,
	) {
...
export function createClientPipeTransport(
	pipeName: string,
	encoding: RAL.MessageBufferEncoding = "utf-8",
...
export function createClientSocketTransport(
	port: number,
	encoding: RAL.MessageBufferEncoding = "utf-8",
