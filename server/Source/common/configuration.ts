...
export const ConfigurationFeature: Feature<_RemoteWorkspace, Configuration> = (
	Base,
) => {
	return class extends Base {
		getConfiguration(
			arg?: string | ConfigurationItem | ConfigurationItem[],
		): Promise<any> {
			if (!arg) {
		...
		private _getConfiguration(
			arg: ConfigurationItem | ConfigurationItem[],
		): Promise<any> {
